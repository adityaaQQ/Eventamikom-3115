...
<body class="bg-indigo-50/30 text-slate-900">
    ...
    <main class="max-w-3xl mx-auto px-6 py-20">
        <div class="mb-12">
            <a href="{{ url('/') }}" class="text-indigo-600 font-bold flex items-center gap-2 mb-6">
    ...
    <div id="midtrans-overlay"
        ...
        <div class="bg-white w-full max-w-sm rounded-[2rem] overflow-hidden shadow-2xl animate-bounce-in relative">
            
            <div class="bg-slate-50 p-6 flex justify-between items-center border-b">
                <div class="flex items-center gap-1">
                    <span class="font-black text-indigo-600 tracking-tighter text-xl">midtrans</span>
                    <span class="text-[8px] bg-indigo-600 text-white px-1.5 py-0.5 rounded font-bold">PAYMENT</span>
                </div>
                <button onclick="hideMidtrans()" class="text-slate-400 hover:text-slate-600 transition">
